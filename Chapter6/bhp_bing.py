...
bing_api_key = "d93cfea642654d389d77729464fa2fa5"
...
class BurpExtender(IBurpExtender, IContextMenuFactory):
    ...
    def bing_query(self, bing_query_string):
        ...
        print quoted_query
        http_request = "GET https://api.cognitive.microsoft.com/bing/v7.0/searchweb?$format=json&$top=20&Query=%s HTTP/1.1\r\n" % quoted_query
